...
def reg_model(learning_rate, use_two_fc, use_two_conv, hparam):
  ...
  fc1 = fc_layer(x, 1024, 512, "fc1")
  relu1 = tf.nn.relu(fc1)
  fc2 = fc_layer(relu, 512, 256, "fc2")
  Y_pred = tf.nn.relu(fc2)
  ...
  for i in range(2001):
    ...
    if i % 50 == 2:
      rmsle = sess.run([RMSLE], {x: training_set2.drop(['trip_duration_log'], axis=1).as_matrix(), y:  training_set2['trip_duration_log'].as_matrix()})
